...
- [x] ▸ Checkpoint A: gate RED, Sınıf-1 drop'lar görünür
...
- [x] ▸ Checkpoint B: mevcut fixture'da gate YEŞİL
...
- [x] ▸ Checkpoint C: latent drop'lar kapandı
...
- [x] D4 · @http/@trigger → hedef-stub + policy (M) — Open Q2

## Phase E — Tam fixture + final gate
- [x] E1 · full-coverage fixture (her keyword) (M)
- [x] E2 · final gate YEŞİL + regression (.NET+Go compile, determinizm, tüm test) (S)
- [x] ▸ Checkpoint E (Complete): INV-7 mekanik zorlanıyor
